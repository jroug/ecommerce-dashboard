...
export function ProductNotFound() {
  return (
    <main className="mx-auto max-w-[720px] px-4 py-16 text-center sm:px-6">
      <div className="admin-card px-6 py-12">
        <PackageSearch className="mx-auto text-[var(--color-text-muted)]" size={36} />
        <h1 className="mt-4 text-[20px] font-semibold">Product not found</h1>
